        ...
        <div className="container mx-auto px-6 py-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              ...
              { icon: RefreshCw, label: 'Satisfait ou remboursé 14j' },
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-background/40">
              ...
              <li><Link to="/politique-de-retour" className="hover:text-accent transition-colors">Politique de retour 14j</Link></li>
