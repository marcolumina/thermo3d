...
const SOCIAL_LINKS = [
  { name: 'Instagram', href: 'https://instagram.com/thermo3d', icon: (
  ...
  { name: 'X', href: 'https://x.com/thermo3d', icon: (
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
            ...
            <div className="flex items-center gap-3 mt-6">
              {SOCIAL_LINKS.map(({ name, href, icon }) => (
                <a
                  ...
                  aria-label={name}
                  className="w-9 h-9 rounded-full bg-background/10 flex items-center justify-center text-background/60 hover:bg-accent hover:text-accent-foreground transition-colors"
                >
                  {icon}
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm text-background/40">
              ...
              <li><Link to="/mon-compte" className="hover:text-accent transition-colors">Mon espace</Link></li>
