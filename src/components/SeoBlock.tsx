    ...
    <section className="border-t border-border/60">
      <div className="container mx-auto px-6 py-14 md:py-20">
        <div className="max-w-3xl mx-auto space-y-6 text-sm text-muted-foreground leading-relaxed">
          ...
          <p>
            Explorez nos <Link to="/accessoires-tm6" className="text-accent hover:underline">accessoires TM6</Link> et <Link to="/accessoires-tm7" className="text-accent hover:underline">accessoires TM7</Link> pour trouver les solutions adaptées à votre modèle. Plus de 1000 clients nous font confiance avec une note de 4,8/5. Livraison offerte dès 50€, satisfait ou remboursé 30 jours. Découvrez aussi nos <Link to="/blog" className="text-accent hover:underline">guides et conseils</Link> pour optimiser votre cuisine au quotidien.
          </p>
        </div>
      </div>
    </section>
