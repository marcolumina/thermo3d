  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      <Helmet>
        ...
        <meta name="description" content="CGV Thermo3D : commande, paiement, livraison, droit de rétractation 14j, garantie satisfait ou remboursé 30 jours sur vos accessoires Thermomix." />
      ...
      <main className="container mx-auto px-6 py-16 max-w-3xl">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-muted-foreground">
          ...
          <section>
            <h2 className="font-display text-lg font-semibold text-foreground mb-2">Article 8 – Garantie « Satisfait ou Remboursé » 30 jours</h2>
            <p>
              En complément du droit légal de rétractation, Thermo3D offre une <strong>garantie commerciale « Satisfait ou Remboursé » de 30 jours</strong> à compter de la réception. Si le produit ne vous convient pas, vous pouvez le retourner et être intégralement remboursé. Conditions et modalités détaillées dans notre <Link to="/politique-de-retour" className="text-primary underline">Politique de retour</Link>.
            </p>
          </section>
