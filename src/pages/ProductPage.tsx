...
const faqs = [
  { q: 'Est-ce compatible avec mon Thermomix TM6 ?', a: "Oui ! Tous nos accessoires sont compatibles avec les modèles Thermomix TM5, TM6 et TM7. L'ajustement est parfait grâce à l'impression 3D de précision." },
